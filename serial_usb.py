...
#     # def start_streaming(self, use_lsl=False):
#     #     if use_lsl:
#     #         # info = StreamInfo('BioAmpDataStream', 'EXG', self.num_channels, self.supported_boards[self.board]["sampling_rate"],'float32', 'UpsideDownLabs')
...
#     client.start_streaming(use_lsl=True)
